package org.azertio.jsonrpc.serve;
...
public class JsonRpcServer {
    ...
    public interface ExecHandler {
         ...
         * Uses the stored plan node tree as-is rather than rebuilding from azertio.yaml,
    ...
    public void run() {
        ...
        closeRepository();
        log.info("Azertio serve: stopped");
    }
    ...
    private void handleRefresh() {
        closeRepository();
        repository = factory.open();
        log.info("Azertio serve: repository refreshed");
    }
